        ...
        <tr>
            <td valign="top" width="20%">
                ...
                <ul style="color: rgb(0, 0, 0);" align="left">
                    ...
                    <li><a style="color: rgb(116, 168, 64); font-size: x-large;" href="feedBack.php">Feedback</a>
                    </li><br>
                ...
                <table style="border:2px solid rgb(0, 0, 0);" width="70%" height="88%" align="center">
                    <tr>
                        <td height="80px" align="center">
                            <b style="font-size: xx-large; color: rgb(0, 0, 0);">Write A
                                Feedback</b>
                            <hr width="100%">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <form action="" method="get" align="center">
                                <br>
                                <textarea rows="25" cols="80" name="description" placeholder=" Enter Account Number">
                            </textarea><br><br>
