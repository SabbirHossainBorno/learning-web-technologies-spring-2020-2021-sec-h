...
function changePassword(){
    ...
    if(rnpassword == "" || cpassword ==""|| npassword =="" ){
        ...
        if(passwordValidator(npassword, rnpassword)){
            ...
            var xhttp = new XMLHttpRequest();
            xhttp.open('POST', '../../controller/user/forgotPassword.php', true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
               ...
               if(emailValidation(email)){
                ...
                if(isNaN(mobileNumber)==false){
                   ...
                   if(passwordValidator(password, cpassword)){
                       ...
                       }else{document.getElementById('response').innerHTML = "Enter Username Again";}
                       
                   }else{document.getElementById('response').innerHTML = "Enter Password Again";}

                }else{document.getElementById('response').innerHTML = "Mobile Number accepts only Numbers";}
                   
               }else{document.getElementById('response').innerHTML = "Invalid Email \n Enter Email Again";}
               
           }else{document.getElementById('response').innerHTML = "Invalid Name \n Enter Name Again";}
    ...
    if(name == "" || email == "" || dob == "" || gender == ""){
        ...
        if(nameValidation(name)){
            ...
            if(emailValidation(email)){
                ...
                var xhttp = new XMLHttpRequest();
                xhttp.open('POST', '../../controller/user/edit.php', true);
                xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function imageUpload()
{
    ...
    if(image == ""){
        ...
        {
            var xhttp = new XMLHttpRequest();
                xhttp.open('POST', '../../controller/user/uploadImage.php', true);
                xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
