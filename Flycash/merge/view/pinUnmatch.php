...
<body style="background-color:rgb(0, 0, 0);">
    ...
    <table style="border:2px solid rgb(255, 255, 255); border-collapse: collapse;" align="center" width="70%">
        ...
        <tr>
            ...
            <td style="border:2px solid rgb(255, 255, 255); border-collapse: collapse;" colspan="2" align="right">

                <img align="left" src="../assets/flycash.png" alt="Logo" width="200" height="100">
                <br><br>

                <b style=" font-size: xx-large; color: rgb(255, 255, 255);">Logged in as </b>
                <a href="../view/dashboard.php"><b style=" font-size: xx-large; color: rgb(116, 168, 64);"><?php echo $name ?></b></a>
        </tr>
        ...
        <tr>
            ...
            <td style="border:2px solid rgb(255, 255, 255); border-collapse: collapse;" width="68%" height="698px">
                <table style="border:2px solid rgb(255, 255, 255);" width="70%" height="88%" align="center">
                    <tr>
                        <td height=30px colspan="2">
                            <div align="center">
                                <b style="font-size: x-large; color: rgb(255, 255, 255);">Cash In - Bank</b>
                            </div>
                            <hr width="50%">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height=30px colspan="2">
                            <div align="center">
                                <b style="font-size: x-large; color: rgb(255, 255, 255);"> Balance : <?=$balance?>&nbsp;&nbsp;TK</b>
                            </div>
                            <hr width="100%">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="border:2px solid black; border-collapse: collapse;" width="68%" height="250px">
                            ...
                            <form action="../controller/transactioncheck.php" method="post">
                                ...
                                <b style="font-size: x-large; color: rgb(255, 255, 255);">Your FlyCash PIN Doesn't Match.</b>
                                <b style="font-size: x-large; color: rgb(255, 255, 255);">Try Again Please.</b>
