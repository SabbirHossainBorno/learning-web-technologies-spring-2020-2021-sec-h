...
//New Pin Validation
function newPasswordValidation(npin, rnpin) {
...
function pinChangeCheck() {
    ...
    if (rnpin == "" || cpin == "" || npin == "") {
        ...
        if (newPasswordValidation(npin, rnpin)) {

            var xhttp = new XMLHttpRequest();
            xhttp.open('POST', '../controller/pinchange.php', true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function passwordChangeCheck() {
    ...
    if (rnpassword == "" || cpassword == "" || npassword == "") {
        ...
        if (newPasswordValidation(npassword, rnpassword)) {
            ...
            var xhttp = new XMLHttpRequest();
            xhttp.open('POST', '../controller/passwordchange.php', true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            ...
            if (usernameValidation(username)) {
                ...
                if (emailValidation(email)) {
                    ...
                    if (nidNumberValidation(nidnumber)) {
                        ...
                        var xhttp = new XMLHttpRequest();
                        xhttp.open('POST', '../../controller/merhcant/editprofile.php', true);
                        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
