        ...
        <tr>
            <td valign="top" width="20%">
                ...
                <ul style="color: rgb(0, 0, 0);" align="left">
                    ...
                    <li><a style="color: rgb(116, 168, 64); font-size: x-large;" href="changepassword.php">Change
                            Password</a>
                    </li><br>
                ...
                <table style="border:2px solid rgb(0, 0, 0);" width="70%" height="88%" align="center">
                    <tr>
                        <td height="80px" align="center">
                            <b style="font-size: xx-large; color: rgb(0, 0, 0);">Change Password</b>
                            <hr width="100%">
                        </td>
                    </tr>
                        ...
                        <td align="center">
                            <fieldset style=" color: rgb(0, 0, 0); width: 500px; height: 300px;">
                                ...
                                <b style="color: rgb(0, 0, 0);">New
                                    Password</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<input
                                    type="text" name="npassword" id="npassword">
                                <hr>
                                <b style="color: rgb(0, 0, 0);">Re-enter
                                    Password</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                                <input type="text" name="rnpassword" id="rnpassword">
                                <hr>
                                <br><br>
                                <input type="submit" id="change" value="Change Password"
                                    onclick="passwordChangeCheck()">
