                ...
                <table style="border:2px solid rgb(0, 0, 0);" width="70%" height="88%" align="center">
                    <tr>
                        <td height=30px colspan="2">
                            <div align="center">
                                <b style="font-size: x-large; color: rgb(0, 0, 0);">Cash In</b>
                            </div>
                            <hr width="50%">
                        </td>
                    </tr>
                        ...
                        <td>
                            <form action="../../controller/merchant/transactioncheck.php" method="post">
                                ...
                                <fieldset style="width:60%;  margin:  0px auto;">
                                    ...
                                    <b style="color: rgb(0, 0, 0);">User Account
                                        Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</b><input type="text"
                                        name="number" placeholder=" 017xxxxxxx" title="Enter your 11 digit mobile number 
                                        Hint: 017xxxxxxxx" required><br><br>
